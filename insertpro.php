...
if (isset($_POST["new_btn"])) {
    ...
    $insert="INSERT INTO `products`(`PRODUCT_NAME`, `CATEGORY`, `BRAND`, `SALE_PRICE`, `PURCHASE_PRICE`, `QUANTITY`, `DESCRIPTION`) VALUES ('$p','$c','$b','$s','$pur','$qua','$des')";
                            ...
                            <div class="card-body">
                                <form action="" method="post" class="form-horizontal form-material">
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="col-md-12 border-bottom p-0">
                                            <!-- <input type="text" placeholder="Choose brand"
                                                class="form-control p-0 border-0" name="BRAND"
                                                id="example-email"> -->
