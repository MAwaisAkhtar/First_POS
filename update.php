...
$upd="UPDATE `project` SET `Admin_name`='$n',`Admin_password`='$p' WHERE id=$id";
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="text" placeholder="Enter name"
                                                class="form-control p-0 border-0" name="name" value="<?php echo $row["Admin_name"]   ?>"> </div>
                                    </div>
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="text" placeholder="Enter password"
                                                ...
                                                id="example-email" value="<?php echo $row["Admin_password"]   ?>">
                                        </div>
                                    </div>
