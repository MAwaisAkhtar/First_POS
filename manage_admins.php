                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">
                            ...
                            <input type="submit" name="" value="Add Admin" class="btn btn-success text-white"><br>
                            </form>
                                    ...
                                    <?php while($row=mysqli_fetch_assoc($srun)){ ?>
                                        ...
                                        <tr>
                                            ...
                                            <?php
                                             ...
                                             if ($_SESSION['a'] == $row['id']) {
                                                echo "<button class='btn btn-success text-white'>self account</button>";
                                            } 
                                            else{
